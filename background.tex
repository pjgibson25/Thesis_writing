...
\begin{figure}[ht!]
  ...
  \caption{A depiction of near-Earth object classification.\inlinecomment{Include a description of each type in the caption itself. Imagine someone not reading the text and just reading the captions. And why is it so tiny?}}
  \label{jed}
\end{figure}
...
However, a small camera system that cannot yield similar data to more professional surveys serves only a marginal amount of utility.\comment{I think the important part about these past 3 sentences is that a professional system greatly assists with the collation and automation of the data-processing. Building in redundancy and self-confirmation from multiple cameras. The optics and cameras themselves don't necessarily differ that much.}
...
Nearly all of this data is widely available, and is available to the public online.\comment{Might be careful stating how much of the data is available. Times and dates of impacts or peak magnitudes usually are, but finding things like full light curves or area of observed sky is a lot harder to find.}
